...
import 'package:paheli/QuestionBank2.dart';
import 'package:paheli/choosing_screen.dart';
import 'package:step_progress_indicator/step_progress_indicator.dart';
import 'package:flutter_icons/flutter_icons.dart';

QuestionBank2 questionBank2=QuestionBank2();
...
class GameScreen2 extends StatefulWidget {
  GameScreen2({this.correctQuestions,this.incorrectQuestion});
          ...
          child: SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  QuestionCard(questionName: questionBank2.getQuestion(),answersList: [questionBank2.getAns1(),questionBank2.getAns2(),questionBank2.getAns3(),questionBank2.getAns4()],),//See QuestionCard class below to understand.
                  RaisedButton(
                    color: Colors.lightGreen,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                    onPressed: (){
                      if(addans2.length==14&&(tapState1==true||tapState2==true||tapState3==true||tapState4==true)){
                        Navigator.push(context, MaterialPageRoute(builder:(context)=>Report()));
                      }
                      setState(() {
                        if(tapState1==true||tapState2==true||tapState3==true||tapState4==true)
                          questionBank2.nextQ();
                        addans2.add(Icon(Icons.check));
                        tapState1=false;
                        tapState2=false;
                        tapState3=false;
                        tapState4=false;
                  ...
                  Text('Question : ${addans2.length+1}/$totalQuestions',style: TextStyle(fontSize: 15.0),),
...
class _QuestionCardState extends State<QuestionCard> {
  Color box(String ans){
    String correctans=questionBank2.getCorrectans();
    if(ans==correctans){
      correctCount++;
      return Colors.green;
        ...
        body: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: ScoreCards(text: "Questions: 15",),
              ),
              Padding(
                padding: const EdgeInsets.all(16.0),
