...
import 'package:paheli/QuestionBank.dart';
...
class GameScreen extends StatefulWidget {
  GameScreen({this.correctQuestions,this.incorrectQuestion});
...
class _GameScreenState extends State<GameScreen> {
  int currentQuestionNumber =questionBank.questionNumber();
        ...
        body: Container(
          ...
          child: SafeArea(
            ...
            children: <Widget>[
              ...
              QuestionCard(questionName: questionBank.getQuestion(),answersList: [questionBank.getAns1(),questionBank.getAns2(),questionBank.getAns3(),questionBank.getAns4(),questionBank.getCorrectans()],),//See QuestionCard class below to understand.
              RaisedButton(
                color: Colors.lightGreen,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                onPressed: (){
                  if(addans.length==9&&(tapState1==true||tapState2==true||tapState3==true||tapState4==true)){
                    Navigator.push(context, MaterialPageRoute(builder:(context)=>Report()));
                  }
                 setState(() {
                   if(tapState1==true||tapState2==true||tapState3==true||tapState4==true){
                     questionBank.nextQ();
                     addans.add (Icon (Icons.check));
                   }
                   tapState1=false;
                   tapState2=false;
                   tapState3=false;
              ...
              Text('Question : ${addans.length+1}/$totalQuestions',style: TextStyle(fontSize: 15.0),),
...
class _QuestionCardState extends State<QuestionCard> {
  Color box(String ans){
    String correctans=widget.answersList[4];
    if(ans==correctans) {
      correctCount++;
      return Colors.green;
    }
